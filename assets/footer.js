(function(){
      ...
      '<div class="footer-main-row" style="display:flex;margin-bottom:4px;justify-content:space-between;align-items:flex-start;">' +
        '<div style="white-space:nowrap;">' +
          ...
          '<div style="color:#ddd;margin-top:8px;font-size:0.875rem;">' +
            '<p style="margin:0;">© 2025 주식회사 인피니크. All rights reserved.<a href="__ADMIN__" aria-label="." style="display:inline-block;width:3px;height:3px;background:rgba(255,255,255,0.08);margin-left:6px;vertical-align:middle;border-radius:50%;"></a></p>' +
          '</div>' +
        '</div>' +
        '<div style="display:flex;flex-direction:column;align-items:flex-end;gap:12px;">' +
          '<a href="https://infinique.kr" target="_blank" rel="noopener" aria-label="infinique.kr">' +
            '<img src="__ASSETS__/infinique_logo.svg" alt="Infinique" style="width:160px;height:auto;">' +
          '</a>' +
          '<a href="https://infinique.co.kr" target="_blank" rel="noopener" aria-label="infinique.co.kr">' +
    ...
    '<div class="max-w-[1920px] mx-auto">' +
      '<div class="footer-main-row" style="display:flex;margin-bottom:4px;justify-content:space-between;align-items:flex-start;">' +
        '<div style="white-space:nowrap;">' +
          ...
          '</span>' +
          '<div style="color:#ddd;margin-top:8px;font-size:0.875rem;">' +
            '<p style="margin:0;">© 2025 Infinique Inc. All rights reserved.<a href="__ADMIN__" aria-label="." style="display:inline-block;width:3px;height:3px;background:rgba(255,255,255,0.08);margin-left:6px;vertical-align:middle;border-radius:50%;"></a></p>' +
          '</div>' +
        '</div>' +
        '<div style="display:flex;flex-direction:column;align-items:flex-end;gap:12px;">' +
          '<a href="https://infinique.kr" target="_blank" rel="noopener" aria-label="infinique.kr">' +
  ...
  function inject() {
    ...
    var assets = isEn ? '../assets' : './assets';
    var admin = isEn ? '../admin.html' : './admin.html';
    var html = (isEn ? FOOTER_EN : FOOTER_KO)
      .replace(/__ASSETS__/g, assets)
      .replace(/__ADMIN__/g, admin);
    el.outerHTML = html;
  }
